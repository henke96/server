...
static inline int32_t nolibc_accept4(int32_t fd, void *addr, int32_t *restrict addrlen, int32_t flags) {
    nolibc_SYSCALL4(nolibc_NR_accept4, fd, addr, addrlen, flags);
    return (int32_t)ret;
}

static inline int64_t nolibc_sendto(int32_t fd, const void *buf, int64_t len, int32_t flags, const void *addr, int32_t addrlen) {
    nolibc_SYSCALL6(nolibc_NR_sendto, fd, buf, len, flags, addr, addrlen);
    return ret;
}

static inline int64_t nolibc_sendmsg(int32_t fd, const struct msghdr *msg, int32_t flags) {
    nolibc_SYSCALL3(nolibc_NR_sendmsg, fd, msg, flags);
    return ret;
}

static inline int64_t nolibc_recvfrom(int32_t fd, const void *restrict buf, int64_t len, int32_t flags, const void *restrict addr, int32_t *restrict addrlen) {
    nolibc_SYSCALL6(nolibc_NR_recvfrom, fd, buf, len, flags, addr, addrlen);
    return ret;
}

static inline int32_t nolibc_epoll_create1(int32_t flags) {
...
static inline int32_t nolibc_timerfd_create(int32_t clockid, int32_t flags) {
    nolibc_SYSCALL2(nolibc_NR_timerfd_create, clockid, flags);
    return (int32_t)ret;
}

static inline int32_t nolibc_timerfd_settime(int32_t fd, int32_t flags, const struct itimerspec *new, struct itimerspec *old) {
